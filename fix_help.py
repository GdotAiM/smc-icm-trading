...
# Replace the embedHelp function
old_help = """function embedHelp() {
...
if old_help in content:
    print("Found old_help pattern, replacing...")
    ...
    with open('C:\Users\cash\projects\smc-icm-trading\\tools\\discord_bot.cjs', 'w', encoding='utf8') as f:
        f.write(new_content)
    print("SUCCESS: embedHelp function replaced")
    # Verify
    with open('C:\Users\cash\projects\smc-icm-trading\\tools\\discord_bot.cjs', 'r', encoding='utf8') as f:
        verify = f.read()
    if '🔹 Quick Start' in verify:
        print("Verification: Quick Start tag found")
else:
    print("FAILED: old_help pattern not found in file")
    # Try to find what's actually there
    m = re.search(r'function embedHelp\(', content)
    if m:
        print("Found function, showing first 500 chars:", m.group()[:500])
    else:
        print("Function embedHelp not found at all")