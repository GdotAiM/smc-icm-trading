...
- **Cycle Phase**: UNKNOWN | **MMXM Step**: undefined/4
...
|-------|-----------|---------|-----|-------|--------|
| MMXM Buy Model | 8/9 | ×1.00 | ⚠️ BLOCKED | **2.40** | ★ PRIMARY |
...
| MMXM Sell Model | 5/9 | ×1.00 | ⚠️ BLOCKED | **1.50** | Rejected |
| Turtle Soup | 5/7 | ×1.00 | ⚠️ BLOCKED | **1.50** | Rejected |
| Breaker Block | 5/7 | ×1.00 | ⚠️ BLOCKED | **1.50** | Rejected |
...
## Primary: MMXM Buy Model (2.40 — structural 8 × cycle 1.00)
