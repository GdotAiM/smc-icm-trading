# Fractal MMXM Coherence — EURUSD — 2026-08-02
...
| 4H | **3** | DISTRIBUTION | 0.80 | BOS bullish confirmed. 2 FVG(s). Displacement: weak (0.39x). Trend is distributing. |
...
| 15m | **3** | DISTRIBUTION | 0.80 | BOS bullish confirmed. 3 FVG(s). Displacement: moderate (1.26x). Trend is distributing. |
