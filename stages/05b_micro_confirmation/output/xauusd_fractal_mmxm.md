# Fractal MMXM Coherence — XAUUSD — 2026-07-29
...
| 1D | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 2 FVG(s). Displacement: weak (0.37x). Trend is distributing. |
| 4H | **2** | MANIPULATION | 0.85 | Sweep (SSL,BSL,SSL) + CHoCH reversal. Classic manipulation. The trap is set — wait for reversal to confirm. |
| 1H | **3** | DISTRIBUTION | 0.60 | BOS bearish detected. Distribution beginning. Waiting for displacement confirmation. |
| 15m | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 1 FVG(s). Displacement: moderate (1.13x). Trend is distributing. |
| 5m | **3** | DISTRIBUTION | 0.60 | BOS bearish detected. Distribution beginning. Waiting for displacement confirmation. |
...
- ❌ 1D Step 3 → 4H Step 2 — 1D Step 3 → 4H Step 2 — LTF behind HTF. Nesting broken.
