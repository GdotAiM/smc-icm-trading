# Fractal MMXM Coherence — GBPUSD — 2026-08-03
...
| 4H | **3** | DISTRIBUTION | 0.80 | BOS bullish confirmed. 2 FVG(s). Displacement: moderate (0.92x). Trend is distributing. |
| 1H | **4** | RE-ACCUMULATION | 0.65 | Price returning to OB/FVG zone. Building base before next expansion. 3 prior sweep(s). |
| 15m | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 3 FVG(s). Displacement: weak (0.15x). Trend is distributing. |
...
- ✅ 4H Step 3 → 1H Step 4 — 4H Step 3 → 1H Step 4 — correctly nested
- ❌ 1H Step 4 → 15m Step 3 — 1H Step 4 → 15m Step 3 — LTF behind HTF. Nesting broken.
