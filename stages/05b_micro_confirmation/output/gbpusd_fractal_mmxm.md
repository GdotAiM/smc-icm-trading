# Fractal MMXM Coherence — GBPUSD — 2026-07-31
...
| 4H | **2** | MANIPULATION | 0.85 | Sweep (BSL,SSL,SSL,SSL,SSL,SSL) + CHoCH reversal. Classic manipulation. The trap is set — wait for reversal to confirm. |
| 1H | **3** | DISTRIBUTION | 0.80 | BOS bullish confirmed. 3 FVG(s). Displacement: weak (0.37x). Trend is distributing. |
| 15m | **3** | DISTRIBUTION | 0.80 | BOS bullish confirmed. 1 FVG(s). Displacement: weak (0.02x). Trend is distributing. |
...
- ❌ 5m Step 4 → 1m Step 2 — 5m Step 4 → 1m Step 2 — LTF behind HTF. Nesting broken.
...
| 5 | FVG Creation | ✅ | 5m: 0 FVGs, 1m: 2 FVGs |
