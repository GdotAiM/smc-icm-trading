# Self-Validation — XAUUSD — 2026-08-31
...
| sweep_claim | **PASS** | engine_5m.json | 6 pool(s), 4 swept. |
| sweep_claim | **PASS** | engine_15m.json | 6 pool(s), 4 swept. |
| fvg_claim | **PASS** | engine_5m.json | 1 unmitigated FVG(s) on 5m. |
