...
| MMXM Buy Model | 8/13 | ×1.40 | ✅ | **3.40** | ★ legacy primary |
| OTE + Institutional OB | 6/11 | ×1.40 | ✅ | **2.50** | Rejected |
| Unicorn (OTE+FVG) | 6/11 | ×1.40 | ✅ | **2.50** | Rejected |
| MMXM Sell Model | 5/13 | ×1.40 | ✅ | **2.10** | Rejected |
| SCOB | 5/10 | ×1.40 | ✅ | **2.10** | Rejected |
| 2FVG Entry | 6/7 | ×1.10 | ✅ | **2.00** | Rejected |
| Breaker Block | 8/7 | ×0.50 | ✅ | **1.20** | Rejected |
| Silver Bullet | 3/10 | ×1.10 | ✅ | **1.00** | Rejected |
| Rejection Block | 3/4 | ×0.80 | ✅ | **0.70** | Rejected |
| London Hunt + IFVG | 1/10 | ×1.00 | ✅ | **0.30** | Rejected |
| Turtle Soup | 9/9 | ×0.30 | ⚠️ BLOCKED | **0.00** | Rejected |
...
No soft open — 1-day decline + today not soft (range 57.14% of avg) — reversal risk N/A
