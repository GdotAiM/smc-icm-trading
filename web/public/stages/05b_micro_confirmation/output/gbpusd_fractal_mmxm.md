# Fractal MMXM Coherence — GBPUSD — 2026-09-02
...
|----|------|-------|------------|-----------|
| 1W | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 1 FVG(s). Displacement: moderate (1.21x). Trend is distributing. |
| 1D | **2** | MANIPULATION | 0.85 | Sweep (BSL,SSL,SSL,BSL,BSL,SSL) + CHoCH reversal. Classic manipulation. The trap is set — wait for reversal to confirm. |
| 4H | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 2 FVG(s). Displacement: weak (0.03x). Trend is distributing. |
| 1H | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 1 FVG(s). Displacement: weak (0.13x). Trend is distributing. |
| 15m | **4** | RE-ACCUMULATION | 0.65 | Price returning to OB/FVG zone. Building base before next expansion. 2 prior sweep(s). |
| 5m | **3** | DISTRIBUTION | 0.80 | BOS bullish confirmed. 1 FVG(s). Displacement: weak (0.06x). Trend is distributing. |
| 1m | **3** | DISTRIBUTION | 0.80 | BOS bearish confirmed. 1 FVG(s). Displacement: weak (0.53x). Trend is distributing. |
...
| 5 | FVG Creation | ✅ | 5m: 1 FVGs, 1m: 1 FVGs |
